...
from apps.common.permissions import AddEmail, ChangeEmail, ViewEmail, DeleteEmail
...
class EmailListView(APIView):
    ...
    def get(self,request):
        data= Email.objects.all().exclude(Q(email__icontains='@care-box.com') |  Q(role='carebox'))
