...
from apps.product.models import Product, SubNumber, Asset, UploadProduct, Tag, Department
...
def create_product_admin(
        *, tag: str = None, asset: Asset = None, sub_digit: SubNumber = None, 
        cost_center: CostCenter = None, name: str = None, created_by: User = None, **kwrgs
    ) -> Product:
...
def create_upload_product(
        *, inventory_number: str = None, asset: int = None, sub_number: int = None, 
        cost_center: str = None, name: str = None, created_by=None, department: str = None,
    ) -> UploadProduct:
...
def create_product(
        *, tag: Tag = None, asset: Asset = None, sub_number: SubNumber = None, department: Department = None,
        cost_center: CostCenter = None, name: str = None, created_by: User = None, send_by: User = None
    ) -> Product:
...
def upload_product_update(*, product: UploadProduct, data) -> UploadProduct:
    non_side_effect_fields = ["asset", "sub_digit", "cost_center", "contact_number", "groups",'department']
